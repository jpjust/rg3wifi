...
__PACKAGE__->add_columns(qw/uid id_grupo id_plano data_adesao login senha bloqueado ip nome rg doc data_nascimento telefone endereco bairro cep observacao pppoe kit_proprio cabo valor_instalacao valor_mensalidade/);
